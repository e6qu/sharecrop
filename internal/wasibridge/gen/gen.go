...
func Targets() []Target {
	return []Target{
		...
		{Key: "event", SourceDir: "internal/event", OutputPath: "internal/wasibridge/eventbridge/bridge_gen.go"},
		{Key: "webhook", SourceDir: "internal/webhook", OutputPath: "internal/wasibridge/webhookbridge/bridge_gen.go"},
...
var specs = map[string]storeSpec{
	...
	"event": {
		bridgePackage: "eventbridge",
		domainImport:  "github.com/e6qu/sharecrop/internal/event",
		domainPackage: "event",
		interfaceName: "Store",
		wirePrefix:    "event",
		argCodecs: map[string]argCodec{
			"event.Event":         {field: "Event", goType: "event.Event", wireType: "eventWire", encodeFn: "encodeEvent", decodeFn: "decodeEvent"},
			"event.Recipients":    {field: "Recipients", goType: "event.Recipients", wireType: "[]string", encodeFn: "encodeRecipients", decodeFn: "decodeRecipients"},
			"event.CursorFilter":  {field: "Filter", goType: "event.CursorFilter", wireType: "cursorFilterWire", encodeFn: "encodeCursorFilter", decodeFn: "decodeCursorFilter"},
			"core.DomainEventID":  {field: "EventID", goType: "core.DomainEventID", wireType: "string", encodeFn: "corewire.EncodeDomainEventID", decodeFn: "corewire.DecodeDomainEventID"},
		...
		resultCodecs: map[string]resultCodec{
			"event.AppendStoreResult":   {goType: "event.AppendStoreResult", wireType: "appendResultWire", encodeFn: "encodeAppendResult", decodeFn: "decodeAppendResult", rejectedType: "event.AppendStoreRejected"},
			"event.DispatchStoreResult": {goType: "event.DispatchStoreResult", wireType: "dispatchResultWire", encodeFn: "encodeDispatchResult", decodeFn: "decodeDispatchResult", rejectedType: "event.DispatchStoreRejected"},
			"event.ListStoreResult":     {goType: "event.ListStoreResult", wireType: "listResultWire", encodeFn: "encodeListResult", decodeFn: "decodeListResult", rejectedType: "event.ListStoreRejected"},
		},
	},
	"webhook": {
		bridgePackage: "webhookbridge",
		domainImport:  "github.com/e6qu/sharecrop/internal/webhook",
		domainPackage: "webhook",
		interfaceName: "Store",
		wirePrefix:    "webhook",
		argCodecs: map[string]argCodec{
			"webhook.Subscription":       {field: "Subscription", goType: "webhook.Subscription", wireType: "subscriptionWire", encodeFn: "encodeSubscription", decodeFn: "decodeSubscription"},
			"webhook.Secret":             {field: "Secret", goType: "webhook.Secret", wireType: "string", encodeFn: "encodeSecret", decodeFn: "decodeSecret"},
			"webhook.Owner":              {field: "Owner", goType: "webhook.Owner", wireType: "ownerWire", encodeFn: "encodeOwner", decodeFn: "decodeOwner"},
			"core.WebhookSubscriptionID": {field: "ID", goType: "core.WebhookSubscriptionID", wireType: "string", encodeFn: "corewire.EncodeWebhookSubscriptionID", decodeFn: "corewire.DecodeWebhookSubscriptionID"},
			"core.Page":                  pageArg(),
		},
		resultCodecs: map[string]resultCodec{
			"webhook.CreateStoreResult":         {goType: "webhook.CreateStoreResult", wireType: "createResultWire", encodeFn: "encodeCreateResult", decodeFn: "decodeCreateResult", rejectedType: "webhook.CreateStoreRejected"},
			"webhook.ListStoreResult":           {goType: "webhook.ListStoreResult", wireType: "listResultWire", encodeFn: "encodeListResult", decodeFn: "decodeListResult", rejectedType: "webhook.ListStoreRejected"},
			"webhook.RevokeStoreResult":         {goType: "webhook.RevokeStoreResult", wireType: "revokeResultWire", encodeFn: "encodeRevokeResult", decodeFn: "decodeRevokeResult", rejectedType: "webhook.RevokeStoreRejected"},
			"webhook.ListDeliveriesStoreResult": {goType: "webhook.ListDeliveriesStoreResult", wireType: "deliveriesResultWire", encodeFn: "encodeDeliveriesResult", decodeFn: "decodeDeliveriesResult", rejectedType: "webhook.ListDeliveriesStoreRejected"},
		},
	},
	"notification": {
		...
		argCodecs: map[string]argCodec{
			...
			"notification.StateFilter":  {field: "Filter", goType: "notification.StateFilter", wireType: "string", encodeFn: "encodeStateFilter", decodeFn: "decodeStateFilter"},
		},
		resultCodecs: map[string]resultCodec{
			...
			"notification.CountStoreResult":    {goType: "notification.CountStoreResult", wireType: "countResultWire", encodeFn: "encodeCountResult", decodeFn: "decodeCountResult", rejectedType: "notification.CountStoreRejected"},
	...
	"agent": {
		...
		argCodecs: map[string]argCodec{
			...
			"agent.WorkPolicy":       {field: "WorkPolicy", goType: "agent.WorkPolicy", wireType: "workPolicyWire", encodeFn: "encodeWorkPolicy", decodeFn: "decodeWorkPolicy"},
		},
		resultCodecs: map[string]resultCodec{
			...
			"agent.UpdateWorkPolicyStoreResult": {goType: "agent.UpdateWorkPolicyStoreResult", wireType: "credentialResultWire", encodeFn: "encodeUpdateWorkPolicyResult", decodeFn: "decodeUpdateWorkPolicyResult", rejectedType: "agent.UpdateWorkPolicyStoreRejected"},
			"agent.WorkActivityStoreResult":     {goType: "agent.WorkActivityStoreResult", wireType: "workActivityResultWire", encodeFn: "encodeWorkActivityResult", decodeFn: "decodeWorkActivityResult", rejectedType: "agent.WorkActivityStoreRejected"},
		},
	},
	"orgcred": {
	...
	"assets": {
		...
		argCodecs: map[string]argCodec{
			...
			"assets.CatalogEntry":                             {field: "CatalogEntry", goType: "assets.CatalogEntry", wireType: "catalogEntryWire", encodeFn: "encodeCatalogEntry", decodeFn: "decodeCatalogEntry"},
			"assets.CatalogSlug":                              {field: "CatalogSlug", goType: "assets.CatalogSlug", wireType: "string", encodeFn: "encodeCatalogSlug", decodeFn: "decodeCatalogSlug"},
			"assets.AwardFromCatalogStoreCommand":             {field: "AwardFromCatalogCommand", goType: "assets.AwardFromCatalogStoreCommand", wireType: "awardFromCatalogCommandWire", encodeFn: "encodeAwardFromCatalogCommand", decodeFn: "decodeAwardFromCatalogCommand"},
			"assets.WithdrawCollectibleStoreCommand":          {field: "WithdrawCommand", goType: "assets.WithdrawCollectibleStoreCommand", wireType: "withdrawCollectibleCommandWire", encodeFn: "encodeWithdrawCollectibleCommand", decodeFn: "decodeWithdrawCollectibleCommand"},
			"assets.ReleaseCollectibleStoreCommand":           {field: "ReleaseCommand", goType: "assets.ReleaseCollectibleStoreCommand", wireType: "releaseCollectibleCommandWire", encodeFn: "encodeReleaseCollectibleCommand", decodeFn: "decodeReleaseCollectibleCommand"},
			"assets.TransferToOrganizationStoreCommand":       {field: "TransferToOrganizationCommand", goType: "assets.TransferToOrganizationStoreCommand", wireType: "transferToOrganizationCommandWire", encodeFn: "encodeTransferToOrganizationCommand", decodeFn: "decodeTransferToOrganizationCommand"},
			"assets.TransferFromOrganizationStoreCommand":     {field: "TransferFromOrganizationCommand", goType: "assets.TransferFromOrganizationStoreCommand", wireType: "transferFromOrganizationCommandWire", encodeFn: "encodeTransferFromOrganizationCommand", decodeFn: "decodeTransferFromOrganizationCommand"},
			"core.CollectibleID":                              {field: "CollectibleID", goType: "core.CollectibleID", wireType: "string", encodeFn: "corewire.EncodeCollectibleID", decodeFn: "corewire.DecodeCollectibleID"},
		},
		resultCodecs: map[string]resultCodec{
			"assets.CreateStoreResult":          {goType: "assets.CreateStoreResult", wireType: "collectibleResultWire", encodeFn: "encodeCreateResult", decodeFn: "decodeCreateResult", rejectedType: "assets.CreateStoreRejected"},
			...
			"assets.CatalogListResult":          {goType: "assets.CatalogListResult", wireType: "catalogListResultWire", encodeFn: "encodeCatalogListResult", decodeFn: "decodeCatalogListResult", rejectedType: "assets.CatalogListRejected"},
			"assets.CatalogMutationResult":      {goType: "assets.CatalogMutationResult", wireType: "catalogMutationResultWire", encodeFn: "encodeCatalogMutationResult", decodeFn: "decodeCatalogMutationResult", rejectedType: "assets.CatalogMutationRejected"},
			"assets.WithdrawResult":             {goType: "assets.WithdrawResult", wireType: "withdrawResultWire", encodeFn: "encodeWithdrawResult", decodeFn: "decodeWithdrawResult", rejectedType: "assets.WithdrawRejected"},
			"assets.ReleaseResult":              {goType: "assets.ReleaseResult", wireType: "releaseResultWire", encodeFn: "encodeReleaseResult", decodeFn: "decodeReleaseResult", rejectedType: "assets.ReleaseRejected"},
			"assets.DeleteCollectibleResult":    {goType: "assets.DeleteCollectibleResult", wireType: "acceptedRejectedWire", encodeFn: "encodeDeleteCollectibleResult", decodeFn: "decodeDeleteCollectibleResult", rejectedType: "assets.DeleteCollectibleRejected"},
		},
	},
	"submission": {
		...
		extraImports:  []string{"github.com/e6qu/sharecrop/internal/event", "github.com/e6qu/sharecrop/internal/wasibridge/eventbridge"},
		argCodecs: map[string]argCodec{
			"event.Draft":                   {field: "Draft", goType: "event.Draft", wireType: "eventbridge.DraftWire", encodeFn: "eventbridge.EncodeDraft", decodeFn: "eventbridge.DecodeDraft"},
			"core.UserID":                   userIDArg(),
			"core.Page":                     pageArg(),
			"core.TaskID":                   {field: "TaskID", goType: "core.TaskID", wireType: "string", encodeFn: "corewire.EncodeTaskID", decodeFn: "corewire.DecodeTaskID"},
	...
	"ledger": {
		...
		argCodecs: map[string]argCodec{
			...
			"ledger.PeerTransferStoreCommand":     {field: "PeerTransferCommand", goType: "ledger.PeerTransferStoreCommand", wireType: "peerTransferCommandWire", encodeFn: "encodePeerTransferCommand", decodeFn: "decodePeerTransferCommand"},
		},
		resultCodecs: map[string]resultCodec{
			...
			"ledger.SendResult":           {goType: "ledger.SendResult", wireType: "sendResultWire", encodeFn: "encodeSendResult", decodeFn: "decodeSendResult", rejectedType: "ledger.SendRejected"},
	...
	"task": {
		...
		extraImports:  []string{"github.com/e6qu/sharecrop/internal/event", "github.com/e6qu/sharecrop/internal/wasibridge/eventbridge"},
		argCodecs: map[string]argCodec{
			"event.Plan":              {field: "Plan", goType: "event.Plan", wireType: "eventbridge.PlanWire", encodeFn: "eventbridge.EncodePlan", decodeFn: "eventbridge.DecodePlan"},
			"event.Draft":             {field: "Draft", goType: "event.Draft", wireType: "eventbridge.DraftWire", encodeFn: "eventbridge.EncodeDraft", decodeFn: "eventbridge.DecodeDraft"},
			"core.UserID":             userIDArg(),
			"core.Page":               pageArg(),
			"core.TaskID":             {field: "TaskID", goType: "core.TaskID", wireType: "string", encodeFn: "corewire.EncodeTaskID", decodeFn: "corewire.DecodeTaskID"},
	...
	"moderationtriage": {
		...
		argCodecs: map[string]argCodec{
			...
			"audit.Event":                            {field: "Event", goType: "audit.Event", wireType: "auditwire.EventWire", encodeFn: "auditwire.EncodeEvent", decodeFn: "auditwire.DecodeEvent"},
			"string":                                 {field: "Note", goType: "string", wireType: "string", encodeFn: "corewire.EncodeString", decodeFn: "corewire.DecodeString"},
			"httpserver.ModerationTriageState":       {field: "State", goType: "httpserver.ModerationTriageState", wireType: "string", encodeFn: "encodeTriageState", decodeFn: "decodeTriageState"},
			"httpserver.ModerationTriageStateFilter": {field: "Filter", goType: "httpserver.ModerationTriageStateFilter", wireType: "triageStateFilterWire", encodeFn: "encodeTriageStateFilter", decodeFn: "decodeTriageStateFilter"},
		},
		resultCodecs: map[string]resultCodec{
	...
	"privacy": {
		...
		argCodecs: map[string]argCodec{
			...
			"[]submission.Submission": {field: "Submissions", goType: "[]submission.Submission", wireType: "[]submissionbridge.SubmissionWire", encodeFn: "encodeSubmissions", decodeFn: "decodeSubmissions"},
		},
		resultCodecs: map[string]resultCodec{
