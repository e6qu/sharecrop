...
func adminToolDefinitions() []toolDefinition {
	return []toolDefinition{
		...
		},
		{
			...
			Access:      toolNeedsScope{Value: agent.ScopeModerationRead},
		...
		},
		{
			...
			Access:      toolNeedsScope{Value: agent.ScopeModerationManage},
		...
		},
		{
			...
			Access:      toolNeedsScope{Value: agent.ScopePrivacyRead},
		...
		},
		{
			...
			Access:      toolNeedsScope{Value: agent.ScopePrivacyManage},
		...
		},
		{
			...
			Access:      toolNeedsScope{Value: agent.ScopeOrgRead},
