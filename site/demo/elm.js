				...
				$elm$json$Json$Encode$object(
					_List_fromArray(
						[
							_Utils_Tuple2(
							'kind',
							$elm$json$Json$Encode$string(field.kind))
						])))
			]));
};
						...
						$author$project$Main$applySchemaFields(
							function (fields) {
								return _Utils_ap(
									...
									_List_fromArray(
										[
											{kind: 'string', name: '', required: true}
										]));
							})),
					$elm$core$Platform$Cmd$none);
...
var $author$project$Sharecrop$View$navBar = function (current) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Sharecrop$View$awardCollectibleButton = function (collectible) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Sharecrop$View$awardCollectibleButton(collectible)
			]));
};
var $author$project$Sharecrop$View$collectiblesList = function (state) {
	return $elm$core$List$isEmpty(state.collectibles) ? A2(
		...
		A2($elm$core$List$map, $author$project$Sharecrop$View$collectibleRow, state.collectibles));
};
...
var $author$project$Sharecrop$View$schemaFieldRow = F2(
	function (index, field) {
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('flex flex-col gap-2 rounded-md border border-slate-200 bg-white p-3 sm:flex-row sm:items-end')
				]),
			_List_fromArray(
				[
					A2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Add fields to build an object schema without writing JSON. With no fields the schema is freeform.')
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
...
var $author$project$Sharecrop$View$loggedInView = F2(
	function (origin, state) {
		return A2(
			...
			_List_fromArray(
				[
					$author$project$Sharecrop$View$navBar(state.page),
